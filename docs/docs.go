                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/docs.DeactivateAllRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Участникам установлен статус 'не активен'",
                        "schema": {
                            "$ref": "#/definitions/docs.DeactivateAllResponse"
                        }
                    },
                    "401": {
                        "description": "Нет/неверный админский токен",
